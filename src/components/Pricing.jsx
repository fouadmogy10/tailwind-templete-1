...
const Pricing = () => {
  return (
    <section className="bg-white padding-y" id="pricing">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        ...
        className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
         ...
         initial="hidden"
         whileInView={"show"}
         viewport={{once:false,amount:0.7}} className="flex flex-col p-6 mx-auto max-w-lg text-center  bg-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] xl:p-8  ">
            <h3 className="mb-4 text-2xl  text-secondary font-extrabold">Starter</h3>
            <p className="font-light text-gray-500 sm:text-lg ">
              Best option for personal use & for your next project.
            </p>
            <div className="flex justify-center items-baseline my-8">
              <span className="mr-2 text-5xl font-extrabold text-primary">$29</span>
         ...
         whileInView={"show"}
         viewport={{once:false,amount:0.7}} className="flex flex-col p-6 mx-auto max-w-lg text-center  bg-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] xl:p-8  ">
            <h3 className="mb-4 text-2xl  text-secondary font-extrabold">Advance</h3>
            <p className="font-light text-gray-500 sm:text-lg ">
              Relevant for multiple users, extended & premium support.
            </p>
            <div className="flex justify-center items-baseline my-8">
              <span className="mr-2 text-5xl font-extrabold text-primary">$99</span>
              <span className="text-gray-500 ">/month</span>
            </div>
            <ul role="list" className="mb-8 space-y-4 text-left">
              <li className="flex items-center space-x-3">
         ...
         whileInView={"show"}
         viewport={{once:false,amount:0.7}} className="flex flex-col p-6 mx-auto max-w-lg text-center  bg-white shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] xl:p-8  ">
            <h3 className="mb-4 text-2xl  text-secondary font-extrabold">Premium</h3>
            <p className="font-light text-gray-500 sm:text-lg ">
              Best for large scale uses and extended redistribution rights.
            </p>
            <div className="flex justify-center items-baseline my-8">
              <span className="mr-2 text-5xl font-extrabold text-primary">$499</span>
              <span className="text-gray-500 ">/month</span>
            </div>
            <ul role="list" className="mb-8 space-y-4 text-left">
              <li className="flex items-center space-x-3">
